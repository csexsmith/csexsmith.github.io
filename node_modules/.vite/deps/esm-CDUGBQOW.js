...
import {
  require_bs58
} from "./chunk-WDYKTDPS.js";
import {
  PublicKey,
  Transaction,
  init_index_browser_esm,
  require_bn
} from "./chunk-UTR266O3.js";
import {
  require_base64_js,
  require_ieee754
...
var JSONStringify5 = (data) => JSON.stringify(data, (_8, value) => typeof value === "bigint" ? value.toString() + "n" : value);
var JSONParse4 = (json) => {
  const numbersBiggerThanMaxInt = /([\[:])?(\d{17,}|(?:[9](?:[1-9]07199254740991|0[1-9]7199254740991|00[8-9]199254740991|007[2-9]99254740991|007199[3-9]54740991|0071992[6-9]4740991|00719925[5-9]740991|007199254[8-9]40991|0071992547[5-9]0991|00719925474[1-9]991|00719925474099[2-9])))([,\}\]])/g;
  const serializedData = json.replace(numbersBiggerThanMaxInt, '$1"$2n"$3');
  return JSON.parse(serializedData, (_8, value) => {
...
var Yt2 = class {
  constructor(e4, t3, s5) {
    this.core = e4, this.logger = t3, this.name = Ze2, this.randomSessionIdentifier = ar(), this.initialized = false, this.init = async () => {
      ...
      this.isInitialized();
      const a5 = En(n6), c8 = safeJsonStringify5(r6);
...
tslib/tslib.es6.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=esm-CDUGBQOW.js.map
