...
var require_qrcode = __commonJS({
  "../../../node_modules/qrcode/lib/core/qrcode.js"(exports) {
    ...
    exports.create = function create2(data, options) {
      ...
      return createSymbol(data, version2, errorCorrectionLevel, mask2);
    };
  }
});
...
Object.defineProperty(DEFAULT_CONTEXT2, "wallets", {
  get() {
    logMissingProviderError("read", "wallets");
    return EMPTY_ARRAY;
  }
});
Object.defineProperty(DEFAULT_CONTEXT2, "wallet", {
  get() {
    logMissingProviderError("read", "wallet");
    return null;
  }
});
Object.defineProperty(DEFAULT_CONTEXT2, "publicKey", {
  get() {
...
var WalletContext = (0, import_react4.createContext)(DEFAULT_CONTEXT2);
function useWallet() {
  return (0, import_react4.useContext)(WalletContext);
}
...
_SolanaWalletAdapterWallet_listeners = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_adapter = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_supportedTransactionVersions = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_chain = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_endpoint = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_account = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_connect = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_disconnect = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_on = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_signAndSendTransaction = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_signTransaction = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_signMessage = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_signIn = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_instances = /* @__PURE__ */ new WeakSet(), _SolanaWalletAdapterWallet_connected = function _SolanaWalletAdapterWallet_connected2() {
  var _a;
  const publicKey2 = (_a = __classPrivateFieldGet3(this, _SolanaWalletAdapterWallet_adapter, "f").publicKey) == null ? void 0 : _a.toBytes();
  if (publicKey2) {
    ...
    if (!account || account.address !== address || account.chains.includes(__classPrivateFieldGet3(this, _SolanaWalletAdapterWallet_chain, "f")) || !bytesEqual2(account.publicKey, publicKey2)) {
  ...
  if (transaction.version === "legacy" && arraysEqual2(__classPrivateFieldGet3(this, _SolanaWalletAdapterWallet_supportedTransactionVersions, "f"), ["legacy"]))
...
function useWalletConnectButton() {
  ...
  const handleConnectButtonClick = (0, import_react10.useCallback)(() => {
    connect().catch(() => {
    });
  }, [connect]);
  return {
...
function useWalletDisconnectButton() {
  ...
  const handleDisconnectButtonClick = (0, import_react11.useCallback)(() => {
    disconnect().catch(() => {
    });
  }, [disconnect]);
  return {
...
function useWalletMultiButton({ onSelectWallet }) {
  const { connect, connected, connecting, disconnect, disconnecting, publicKey: publicKey2, select, wallet, wallets } = useWallet();
  let buttonState;
  if (connecting) {
    buttonState = "connecting";
  } else if (connected) {
  ...
  const handleDisconnect = (0, import_react12.useCallback)(() => {
    disconnect().catch(() => {
    });
  }, [disconnect]);
  const handleSelectWallet = (0, import_react12.useCallback)(() => {
...
var Button = (props) => {
  return import_react13.default.createElement(
    ...
    props.startIcon && import_react13.default.createElement("i", { className: "wallet-adapter-button-start-icon" }, props.startIcon),
    props.children,
    props.endIcon && import_react13.default.createElement("i", { className: "wallet-adapter-button-end-icon" }, props.endIcon)
  );
};
...
var WalletIcon = ({ wallet, ...props }) => {
  return wallet && import_react14.default.createElement("img", { src: wallet.adapter.icon, alt: `${wallet.adapter.name} icon`, ...props });
};

// ../../../node_modules/@solana/wallet-adapter-react-ui/lib/esm/BaseWalletConnectionButton.js
function BaseWalletConnectionButton({ walletIcon, walletName, ...props }) {
  return import_react15.default.createElement(Button, { ...props, className: "wallet-adapter-button-trigger", startIcon: walletIcon && walletName ? import_react15.default.createElement(WalletIcon, { wallet: { adapter: { icon: walletIcon, name: walletName } } }) : void 0 });
}
...
function BaseWalletConnectButton({ children, disabled, labels, onClick, ...props }) {
  ...
  return import_react16.default.createElement(BaseWalletConnectionButton, { ...props, disabled: disabled || buttonDisabled, onClick: (e) => {
    if (onClick) {
      onClick(e);
    }
...
function BaseWalletDisconnectButton({ children, disabled, labels, onClick, ...props }) {
  ...
  return import_react17.default.createElement(BaseWalletConnectionButton, { ...props, disabled: disabled || buttonDisabled, onClick: (e) => {
    if (onClick) {
      onClick(e);
    }
    if (e.defaultPrevented) {
...
function BaseWalletMultiButton({ children, labels, ...props }) {
  ...
  const { buttonState, onConnect, onDisconnect, publicKey: publicKey2, walletIcon, walletName } = useWalletMultiButton({
    onSelectWallet() {
  ...
  const content = (0, import_react18.useMemo)(() => {
    if (children) {
      ...
      const base58 = publicKey2.toBase58();
  ...
  }, [buttonState, children, labels, publicKey2]);
  return import_react18.default.createElement(
    "div",
    { className: "wallet-adapter-dropdown" },
    import_react18.default.createElement(BaseWalletConnectionButton, { ...props, "aria-expanded": menuOpen, style: { pointerEvents: menuOpen ? "none" : "auto", ...props.style }, onClick: () => {
      switch (buttonState) {
        case "no-wallet":
          setModalVisible(true);
          break;
    ...
    import_react18.default.createElement(
      ...
      publicKey2 ? import_react18.default.createElement("li", { className: "wallet-adapter-dropdown-list-item", onClick: async () => {
        await navigator.clipboard.writeText(publicKey2.toBase58());
        setCopied(true);
        setTimeout(() => setCopied(false), 400);
      }, role: "menuitem" }, copied ? labels["copied"] : labels["copy-address"]) : null,
      import_react18.default.createElement("li", { className: "wallet-adapter-dropdown-list-item", onClick: () => {
        setModalVisible(true);
        setMenuOpen(false);
      }, role: "menuitem" }, labels["change-wallet"]),
      onDisconnect ? import_react18.default.createElement("li", { className: "wallet-adapter-dropdown-list-item", onClick: () => {
        onDisconnect();
        setMenuOpen(false);
...
function WalletConnectButton(props) {
  return import_react19.default.createElement(BaseWalletConnectButton, { ...props, labels: LABELS });
}
...
var Collapse = ({ id, children, expanded = false }) => {
  ...
  const instant = (0, import_react20.useRef)(true);
  ...
  return import_react20.default.createElement("div", { className: "wallet-adapter-collapse", id, ref, role: "region", style: { height: 0, transition: instant.current ? void 0 : transition } }, children);
};
...
var WalletListItem = ({ handleClick, tabIndex, wallet }) => {
  return import_react21.default.createElement(
    ...
    import_react21.default.createElement(
      Button,
      { onClick: handleClick, startIcon: import_react21.default.createElement(WalletIcon, { wallet }), tabIndex },
      wallet.adapter.name,
      wallet.readyState === WalletReadyState.Installed && import_react21.default.createElement("span", null, "Detected")
    )
  );
};
...
var WalletSVG = () => {
  return import_react22.default.createElement(
    ...
    import_react22.default.createElement("circle", { cx: "48.5", cy: "48", r: "48", fill: "url(#paint0_linear_880_5115)", fillOpacity: "0.1" }),
    import_react22.default.createElement("circle", { cx: "48.5", cy: "48", r: "47", stroke: "url(#paint1_linear_880_5115)", strokeOpacity: "0.4", strokeWidth: "2" }),
    import_react22.default.createElement(
      "g",
      { clipPath: "url(#clip0_880_5115)" },
      import_react22.default.createElement("path", { d: "M65.5769 28.1523H31.4231C27.6057 28.1523 24.5 31.258 24.5 35.0754V60.9215C24.5 64.7389 27.6057 67.8446 31.4231 67.8446H65.5769C69.3943 67.8446 72.5 64.7389 72.5 60.9215V35.0754C72.5 31.258 69.3943 28.1523 65.5769 28.1523ZM69.7308 52.1523H59.5769C57.2865 52.1523 55.4231 50.289 55.4231 47.9985C55.4231 45.708 57.2864 43.8446 59.5769 43.8446H69.7308V52.1523ZM69.7308 41.0754H59.5769C55.7595 41.0754 52.6539 44.1811 52.6539 47.9985C52.6539 51.8159 55.7595 54.9215 59.5769 54.9215H69.7308V60.9215C69.7308 63.2119 67.8674 65.0754 65.5769 65.0754H31.4231C29.1327 65.0754 27.2692 63.212 27.2692 60.9215V35.0754C27.2692 32.785 29.1326 30.9215 31.4231 30.9215H65.5769C67.8673 30.9215 69.7308 32.7849 69.7308 35.0754V41.0754Z", fill: "url(#paint2_linear_880_5115)" }),
      import_react22.default.createElement("path", { d: "M61.4231 46.6172H59.577C58.8123 46.6172 58.1924 47.2371 58.1924 48.0018C58.1924 48.7665 58.8123 49.3863 59.577 49.3863H61.4231C62.1878 49.3863 62.8077 48.7664 62.8077 48.0018C62.8077 47.2371 62.1878 46.6172 61.4231 46.6172Z", fill: "url(#paint3_linear_880_5115)" })
    ),
    import_react22.default.createElement(
      "defs",
      null,
      import_react22.default.createElement(
        ...
        import_react22.default.createElement("stop", { stopColor: "#9945FF" }),
        import_react22.default.createElement("stop", { offset: "0.14", stopColor: "#8A53F4" }),
        import_react22.default.createElement("stop", { offset: "0.42", stopColor: "#6377D6" }),
        import_react22.default.createElement("stop", { offset: "0.79", stopColor: "#24B0A7" }),
        import_react22.default.createElement("stop", { offset: "0.99", stopColor: "#00D18C" }),
        import_react22.default.createElement("stop", { offset: "1", stopColor: "#00D18C" })
      ),
      import_react22.default.createElement(
        "linearGradient",
      ...
      import_react22.default.createElement(
        "clipPath",
        { id: "clip0_880_5115" },
        import_react22.default.createElement("rect", { width: "48", height: "48", fill: "white", transform: "translate(24.5 24)" })
      )
    )
  );
};
...
var WalletModal = ({ className = "", container = "body" }) => {
  ...
  const [fadeIn, setFadeIn] = (0, import_react23.useState)(false);
  const [portal, setPortal] = (0, import_react23.useState)(null);
  const [listedWallets, collapsedWallets] = (0, import_react23.useMemo)(() => {
    const installed = [];
    const notInstalled = [];
  ...
  const hideModal = (0, import_react23.useCallback)(() => {
    setFadeIn(false);
    setTimeout(() => setVisible(false), 150);
  }, [setVisible]);
  const handleClose = (0, import_react23.useCallback)((event) => {
    event.preventDefault();
    hideModal();
  }, [hideModal]);
  const handleWalletClick = (0, import_react23.useCallback)((event, walletName) => {
    select(walletName);
    handleClose(event);
  }, [select, handleClose]);
  const handleCollapseClick = (0, import_react23.useCallback)(() => setExpanded(!expanded), [expanded]);
  const handleTabKey = (0, import_react23.useCallback)((event) => {
    const node = ref.current;
    if (!node)
      return;
  ...
  (0, import_react23.useLayoutEffect)(() => setPortal(document.querySelector(container)), [container]);
  return portal && (0, import_react_dom.createPortal)(import_react23.default.createElement(
    "div",
      ...
      import_react23.default.createElement(
        ...
        import_react23.default.createElement(
          ...
          import_react23.default.createElement(
            "svg",
            { width: "14", height: "14" },
            import_react23.default.createElement("path", { d: "M14 12.461 8.3 6.772l5.234-5.233L12.006 0 6.772 5.234 1.54 0 0 1.539l5.234 5.233L0 12.006l1.539 1.528L6.772 8.3l5.69 5.7L14 12.461z" })
          )
        ),
        listedWallets.length ? import_react23.default.createElement(
          import_react23.default.Fragment,
          null,
          import_react23.default.createElement("h1", { className: "wallet-adapter-modal-title" }, "Connect a wallet on Solana to continue"),
          import_react23.default.createElement(
            "ul",
            { className: "wallet-adapter-modal-list" },
            listedWallets.map((wallet) => import_react23.default.createElement(WalletListItem, { key: wallet.adapter.name, handleClick: (event) => handleWalletClick(event, wallet.adapter.name), wallet })),
            collapsedWallets.length ? import_react23.default.createElement(Collapse, { expanded, id: "wallet-adapter-modal-collapse" }, collapsedWallets.map((wallet) => import_react23.default.createElement(WalletListItem, { key: wallet.adapter.name, handleClick: (event) => handleWalletClick(event, wallet.adapter.name), tabIndex: expanded ? 0 : -1, wallet }))) : null
          ),
          collapsedWallets.length ? import_react23.default.createElement(
            "button",
            ...
            import_react23.default.createElement(
              ...
              import_react23.default.createElement("path", { d: "M0.71418 1.626L5.83323 6.26188C5.91574 6.33657 6.0181 6.39652 6.13327 6.43762C6.24844 6.47872 6.37371 6.5 6.50048 6.5C6.62725 6.5 6.75252 6.47872 6.8677 6.43762C6.98287 6.39652 7.08523 6.33657 7.16774 6.26188L12.2868 1.626C12.7753 1.1835 12.3703 0.5 11.6195 0.5H1.37997C0.629216 0.5 0.224175 1.1835 0.71418 1.626Z" })
            )
          ) : null
        ) : import_react23.default.createElement(
          import_react23.default.Fragment,
          null,
          import_react23.default.createElement("h1", { className: "wallet-adapter-modal-title" }, "You'll need a wallet on Solana to continue"),
          import_react23.default.createElement(
            "div",
            { className: "wallet-adapter-modal-middle" },
            import_react23.default.createElement(WalletSVG, null)
          ),
          collapsedWallets.length ? import_react23.default.createElement(
            import_react23.default.Fragment,
            null,
            ...
            import_react23.default.createElement(
              ...
              import_react23.default.createElement("ul", { className: "wallet-adapter-modal-list" }, collapsedWallets.map((wallet) => import_react23.default.createElement(WalletListItem, { key: wallet.adapter.name, handleClick: (event) => handleWalletClick(event, wallet.adapter.name), tabIndex: expanded ? 0 : -1, wallet })))
            )
          ) : null
        )
      )
    ),
    import_react23.default.createElement("div", { className: "wallet-adapter-modal-overlay", onMouseDown: handleClose })
  ), portal);
};
...
var WalletModalButton = ({ children = "Select Wallet", onClick, ...props }) => {
  ...
  return import_react24.default.createElement(Button, { ...props, className: "wallet-adapter-button-trigger", onClick: handleClick }, children);
};
...
var WalletModalProvider = ({ children, ...props }) => {
  ...
  return import_react25.default.createElement(
    ...
    children,
    visible && import_react25.default.createElement(WalletModal, { ...props })
  );
};
...
function WalletDisconnectButton(props) {
  return import_react26.default.createElement(BaseWalletDisconnectButton, { ...props, labels: LABELS2 });
}
...
function WalletMultiButton(props) {
  return import_react27.default.createElement(BaseWalletMultiButton, { ...props, labels: LABELS3 });
}
export {
